...
@NamedQueries({
        ...
        @NamedQuery(name = "Match.byParams",
                query = "From MatchEntity match " +
                        ...
                        "LEFT JOIN fetch match.courtType c " +
        ...
        @NamedQuery(name = "Match.getMatches",
                query = "From MatchEntity match " +
                        ...
                        "LEFT JOIN fetch match.league l " +
                        "LEFT JOIN fetch match.courtType c " +
                        "WHERE l.name like :league AND " +
                        "c.name like :courtType " +
                        "order by match.date desc"),
...
public class MatchEntity {
    ...
    private CourtTypeEntity courtType;
    ...
    @ManyToOne
    @JoinColumn(name = "court_type", referencedColumnName = "id", nullable = false)
    public CourtTypeEntity getCourtType() {
        return courtType;
    }

    public void setCourtType(CourtTypeEntity courtType) {
